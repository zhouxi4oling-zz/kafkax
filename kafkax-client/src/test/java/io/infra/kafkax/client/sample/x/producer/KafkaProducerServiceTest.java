 ...
 */
public class KafkaProducerServiceTest implements ProducerService {
    ...
    @Override
    public void send() {
        Message<Bean> message = new Message<>("select.test1." + (i.intValue() % 2 + 1), new Bean("hello world[" + i + "]", new Date()));
